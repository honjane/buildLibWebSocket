...
import static com.honjane.websocket.LwsService.MSG_CALLBACK_RECEIVE_MESSAGE;
...
public abstract class ThreadService extends Service {
     ...
     **/
    public synchronized void handleInputMessage(Message msg) {
        try {
            Message m;
            switch (msg.what) {
                ...
                case MSG_THREAD_RESUME:
                    ...
                    break;
                case MSG_CALLBACK_RECEIVE_MESSAGE:
                    if (mOutputMessenger != null) {
     ...
     */
    public void receiveMessage(int msg, Object obj) {
